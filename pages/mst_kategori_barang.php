...
<section class="section">
  ...
  <!-- <div class="row"> -->
    <div class="col-lg-12">
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Master Kategori Barang</h5>
          <span style="float: left;" class="btn btn-success btn-sm" onclick="buka_form_pencarian_jenis()"> Download Kategori Baru <i class="bi bi-download"></i></span>
        </div>
      </div>
    </div>
